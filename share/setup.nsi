...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin" "" "URL:AequitasCoin"
    #    WriteRegStr HKCR "bitcoin\DefaultIcon" "" $INSTDIR\bitcoin-qt.exe
    #    WriteRegStr HKCR "bitcoin\Aequitas-Coin\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\AequitasCoin.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\AequitasCoin.lnk"
