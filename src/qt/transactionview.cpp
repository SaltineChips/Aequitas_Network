    ...
    transactionView(0)
{
    ...
    watchOnlyWidget->addItem(QIcon(fUseDarkTheme ? ":/icons/dark/eye_plus" : ":/icons/eye_plus"), "", TransactionFilterProxy::WatchOnlyFilter_Yes);
    watchOnlyWidget->addItem(QIcon(fUseDarkTheme ? ":/icons/dark/eye_minus" : ":/icons/eye_minus"), "", TransactionFilterProxy::WatchOnlyFilter_No);
