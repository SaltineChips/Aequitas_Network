...
//
// Bootup the masternode, look for a 10,000 AEQL input and register on the network
//
void CActiveMasternode::ManageStatus()
{
    ...
    if(status == MASTERNODE_NOT_PROCESSED) {
        ...
        if(GetMasterNodeVin(vin, pubKeyCollateralAddress, keyCollateralAddress)) {
            ...
            /* donations are not supported in Aequitas-Coin.conf */
...
{
    CAequitasCoinAddress address(collateralAddress);
