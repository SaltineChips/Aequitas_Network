...
#define START_DEVOPS_PAYMENTS_TESTNET          1546123500  // ON  (Saturday, December 29, 2018 10:45 PM)
#define START_DEVOPS_PAYMENTS                  1546123500  // ON  (Saturday, December 29, 2018 10:45 PM)
